window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // DSH's locale service keeps <html lang> in sync with its active language.
    // Read that public signal, never navigator.language / the machine locale.
    function uiLocale() {
    ...
    function subscribeLanguage(listener) {
      if (typeof document === "undefined" || !document.documentElement || typeof MutationObserver === "undefined") return () => {};
    ...
    function useUiLanguage() {
      ...
      useEffect(() => subscribeLanguage(() => rerender((revision) => revision + 1)), []);
    }
    const ZH = {
      "Could not refresh usage. Showing the previous snapshot.": "无法刷新用量，正在显示之前的快照。", "Daily color shows {metric} volume": "每日颜色表示{metric}用量", "Partial usage summary": "不完整的用量汇总", "Usage summary": "用量汇总", "Usage response was empty": "用量响应为空", "Usage request failed ({status})": "用量请求失败（{status}）",
      "Expand a group to see sessions": "展开分组以查看会话", "Indexing usage in the background…": "正在后台索引用量…", "Background usage update failed. Previously cached data is still shown; updates will retry automatically.": "后台用量更新失败。仍显示之前的缓存数据，将自动重试。",
      "Usage": "用量", "Open Usage": "打开用量", "Close Usage": "关闭用量", "Usage overview": "用量概览",
      "30D": "30天", "90D": "90天", "1Y": "1年", "All": "全部", "Tokens": "词元", "tokens": "词元", "Calls": "调用", "API equivalent": "API 等值估算",
      "API estimate": "API 费用估算", "Codex API equivalent": "Codex API 等值估算", "Actual charges": "实际扣费", "Unavailable": "无数据",
      "Total tokens": "词元总量", "Model calls": "模型调用", "Active days": "活跃天数", "Usage trend": "用量趋势", "Token mix": "词元构成", "Activity": "活跃记录", "Models": "模型", "Sessions": "会话",
      "Input": "输入", "Output": "输出", "Cache": "缓存", "Refresh": "刷新", "Close": "关闭", "Try again": "重试",
      "Model": "模型", "Volume": "用量", "Session": "会话", "Title": "标题", "Provider / model": "提供商 / 模型", "API equivalent (USD)": "API 等值估算（美元）",
      "Non-Codex routes · not confirmed charges": "非 Codex 路由 · 非实际扣费", "Not a subscription charge": "不代表订阅扣费", "No invoices or subscription fees in usage logs": "用量日志不包含账单或订阅费用",
      "Combined API equivalent includes Codex; not actual spending": "API 等值合计包含 Codex，不代表实际支出", "Input, output, and cache": "输入、输出与缓存", "Daily color shows tokens volume": "每日颜色表示词元用量",
      "Per-route API estimates and Codex equivalents, not bills": "各路由的 API 估算与 Codex 等值，不是账单",
      "Durable session analytics": "已保存会话的用量分析", "No usage in this range": "此时间范围内没有用量", "No model usage in this range": "此时间范围内没有模型用量",
      "Model breakdown": "模型明细", "Per-model API equivalents, not actual charges": "各模型的 API 等值估算，不是实际扣费", "Codex equivalent · not a subscription charge": "Codex 等值估算 · 非订阅扣费", "API estimate · not a confirmed charge": "API 费用估算 · 非实际扣费",
      "Model breakdown unavailable in this snapshot; update the Host.": "此快照没有模型明细，请更新 Host。", "Breakdown unavailable": "明细不可用", "UNPRICED": "未定价", "Unknown date": "日期未知", "Untitled session": "无标题会话",
      "Search sessions": "搜索会话", "Title, session ID or route": "标题、会话 ID 或路由", "Group by": "分组方式", "No grouping": "不分组", "Exact title": "相同标题", "Created day": "创建日期", "Sort by": "排序方式", "Ascending ↑": "升序 ↑", "Descending ↓": "降序 ↓", "Reverse session sort direction": "反转会话排序方向",
      "No sessions match your search": "没有匹配的会话", "No session usage in this range": "此时间范围内没有会话用量", "Session usage table": "会话用量表",
      "API estimates and Codex equivalents, not actual spending. Expand Model breakdown for each provider’s contribution. Groups include matching sessions only.": "API 估算与 Codex 等值不代表实际支出。展开模型明细可查看各提供商的用量。分组仅包含匹配的会话。",
      "Session usage · API equivalents in USD; actual charges unavailable; unpriced tokens excluded": "会话用量 · API 等值（美元）；实际扣费未知；不计入未定价词元",
      "Analytics range": "分析时间范围", "Chart metric": "图表指标", "Activity color metric": "活跃记录颜色指标", "Less": "少", "More": "多", "M": "一", "W": "三", "F": "五",
      "Usage unavailable": "用量不可用", "Reading usage cache…": "正在读取用量缓存…", "Reading usage cache": "正在读取用量缓存", "Not yet updated": "尚未更新", "Cached session analytics": "缓存会话分析",
      "Last updated {date}": "最近更新于 {date}", "{count} sessions": "{count} 个会话", "{count} models": "{count} 个模型", "{count} tokens": "{count} 个词元", "{count} calls": "{count} 次调用", "{count} tokens unpriced": "{count} 个词元未定价",
      "API estimate {api} · Codex equivalent {codex}": "API 估算 {api} · Codex 等值 {codex}", "Input {input} · Output {output} · Cache read {read} · Cache write {write}": "输入 {input} · 输出 {output} · 缓存读取 {read} · 缓存写入 {write}",
      "{count} of {total} sessions": "{count} / {total} 个会话", "{count} groups": "{count} 个分组", "{output} output · {cache} cache read": "{output} 输出 · {cache} 缓存读取", "{count} calendar days": "{count} 个日历日",
      "{count} active days in the last year": "过去一年有 {count} 个活跃日", "{metric} activity over the last year": "过去一年的{metric}活跃记录", "{metric} per day, quartile color scale from less to more": "每日{metric}，按四分位数从少到多着色", "{metric} / day": "{metric} / 天", " · level {level} of 4": " · 等级 {level} / 4",
      "Interactive {metric} usage trend. Use left and right arrow keys to inspect days.": "交互式{metric}趋势。使用左右方向键查看日期。",
      "{date}. {metric} {value}. {tokens} tokens, {calls} calls, {cost} API equivalent.": "{date}。{metric} {value}。{tokens} 个词元，{calls} 次调用，API 等值 {cost}。",
      "{calls} calls · {cost} API equivalent": "{calls} 次调用 · API 等值 {cost}", "{tokens} tokens · {cost} API equivalent": "{tokens} 个词元 · API 等值 {cost}", "{tokens} tokens · {calls} calls": "{tokens} 个词元 · {calls} 次调用",
      "Updating usage in the background…": "正在后台更新用量…", "Initializing usage cache…": "正在初始化用量缓存…", "Background scan failed; showing the last confirmed cache.": "后台扫描失败，正在显示最近确认的缓存。", "Partial totals": "不完整的统计", "{cached} of {total} sessions cached": "已缓存 {cached} / {total} 个会话", "{count} pending": "{count} 个待处理",
      "Refresh failed; showing the last confirmed totals. {error}": "刷新失败，正在显示最近确认的统计。{error}", "{count} session logs could not be read. Their last cached values are shown when available.": "{count} 个会话日志无法读取。如有缓存，将显示最近的缓存值。",
      "Actual charges are unavailable, not zero. API equivalents do not include subscription fees or prove additional charges. {coverage}% of tokens have a pricing rule. Custom providers use public model list prices unless configured. Cache tokens can count repeated context reads across calls.": "实际扣费未知，并非零。API 等值不包含订阅费用，也不表示额外扣费。{coverage}% 的词元有定价规则。自定义提供商默认采用公开模型价格。缓存词元可能包含多次调用中重复读取的上下文。"
    };
    function t(text, values = {}) {
      if (typeof text !== "string") return text;
      const template = uiLocale() === "zh-CN" && Object.hasOwn(ZH, text) ? ZH[text] : text;
...
/* SVG rings stay circular even when the Web shell applies rounded-corner styling. */
.dsh-usage-mix-panel{container-type:inline-size}
.dsh-usage-mix{display:grid;grid-template-columns:176px minmax(150px,1fr);gap:24px;align-items:center;min-height:0;padding:12px 0;container-type:normal;width:100%;max-width:620px;margin-inline:auto}
.dsh-usage-donut{width:176px;height:176px;aspect-ratio:1;flex:none;background:none;border-radius:0;corner-shape:round}.dsh-usage-donut::after{display:none}.dsh-usage-donut>svg{display:block;width:176px;height:176px;max-width:none}
.dsh-usage-donut-center{inset:32px;display:flex;flex-direction:column;justify-content:center;align-items:center;gap:2px}.dsh-usage-donut-center strong{font-size:28px;line-height:34px;max-width:100%;white-space:nowrap}.dsh-usage-donut-center span{font-size:13px;line-height:20px;max-width:100%;overflow-wrap:anywhere}
.dsh-usage-legend{min-width:0;width:100%;gap:16px}.dsh-usage-legend-row{grid-template-columns:8px minmax(0,1fr) auto;gap:10px;line-height:22px}.dsh-usage-legend-value{white-space:nowrap}
@container(max-width:360px){.dsh-usage-mix{grid-template-columns:1fr;justify-items:center;gap:20px}.dsh-usage-legend{max-width:300px}}
...
`;
    ...
    function formatCompact(value) {
      ...
      return new Intl.NumberFormat(uiLocale(), { notation: "compact", maximumFractionDigits: value >= 1000000 ? 1 : 0 }).format(value);
    }
    function formatCost(value) {
      if (!Number.isFinite(value)) return "—";
      if (value > 0 && value < .01) return "<" + new Intl.NumberFormat(uiLocale(), { style: "currency", currency: "USD", minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(.01);
      return new Intl.NumberFormat(uiLocale(), { style: "currency", currency: "USD", maximumFractionDigits: value < 100 ? 2 : 0 }).format(value);
    }
    ...
    function formatDetailedCost(value) {
      if (!Number.isFinite(value)) return "—";
      return new Intl.NumberFormat(uiLocale(), { style: "currency", currency: "USD", minimumFractionDigits: 2, maximumFractionDigits: value < .01 ? 4 : 2 }).format(value);
    }
    function metricLabel(metric) {
      return t(metric === "cost" ? "API equivalent" : metric === "calls" ? "Calls" : "Tokens");
    }
    function formatMetricExact(value, metric) {
      return metric === "cost" ? formatDetailedCost(value) : formatExact(value);
    }
    function formatDate(date) {
      try { return new Date(date + "T00:00:00Z").toLocaleDateString(uiLocale(), { month: "short", day: "numeric", timeZone: "UTC" }); }
      catch { return date; }
    }
    function formatLongDate(date) {
      try { return new Date(date + "T00:00:00Z").toLocaleDateString(uiLocale(), { year: "numeric", month: "long", day: "numeric", timeZone: "UTC" }); }
      catch { return date; }
    }
    function dayDetails(day, metric) {
      const values = { calls: formatExact(day.calls || 0), tokens: formatExact(day.totalTokens || 0), cost: formatDetailedCost(day.cost || 0) };
      if (metric === "totalTokens") return t("{calls} calls · {cost} API equivalent", values);
      if (metric === "calls") return t("{tokens} tokens · {cost} API equivalent", values);
      return t("{tokens} tokens · {calls} calls", values);
    }
    function rangeDescription(snapshot) {
      if (!snapshot) return t("Durable session analytics");
    ...
    function Segment({ values, selected, onChange, label }) {
      return h("div", { className: "dsh-usage-segment", role: "group", "aria-label": t(label) }, values.map((value) => h("button", { key: value.id, type: "button", "data-active": value.id === selected ? "true" : undefined, "aria-pressed": value.id === selected, onClick: () => onChange(value.id) }, t(value.label))));
    }

    function StatCard({ label, value, detail, accent }) {
      return h("article", { className: "dsh-usage-card", style: { "--card-accent": accent } },
        h("div", { className: "dsh-usage-card-label" }, t(label)),
        h("div", { className: "dsh-usage-card-value", title: t(value) }, t(value)),
        h("div", { className: "dsh-usage-card-detail" }, t(detail)),
      );
    }
    ...
    function TrendChart({ days, metric }) {
      ...
      if (!days.length) return h("div", { className: "dsh-usage-chart-empty" }, t("No usage in this range"));
      ...
      return h("div", { className: "dsh-usage-chart-scroll" }, h("svg", {
        ...
        "aria-label": t("Interactive {metric} usage trend. Use left and right arrow keys to inspect days.", { metric: metricLabel(metric).toLowerCase() }),
    ...
    function compactParts(value) {
      if (!Number.isFinite(value)) return { number: "—", unit: "" };
      const parts = new Intl.NumberFormat(uiLocale(), { notation: "compact", maximumFractionDigits: value >= 1000000 ? 1 : 0 }).formatToParts(value);
      return { number: parts.filter((p) => p.type !== "compact").map((p) => p.value).join("").trim(), unit: parts.filter((p) => p.type === "compact").map((p) => p.value).join("") };
    }
    ...
    function TokenMix({ summary }) {
      ...
      const parts = compactParts(summary.totalTokens ?? total);
      const rows = [
      ...
      let offset = 0;
      const rings = rows.filter((row) => row.value > 0).map((row) => {
        const length = row.value / total * 100;
        const ring = h("circle", { key: row.label, cx: 88, cy: 88, r: 76, fill: "none", stroke: row.color, strokeWidth: 18, pathLength: 100, strokeDasharray: `${length} ${100 - length}`, strokeDashoffset: -offset, transform: "rotate(-90 88 88)" });
        offset += length;
        return ring;
      });
      return h("div", { className: "dsh-usage-mix" },
        h("div", { className: "dsh-usage-donut" },
          h("svg", { viewBox: "0 0 176 176", width: 176, height: 176, "aria-hidden": "true" }, h("circle", { cx: 88, cy: 88, r: 76, fill: "none", stroke: "var(--dsh-usage-border)", strokeWidth: 18 }), rings),
          h("div", { className: "dsh-usage-donut-center", title: t("{count} tokens", { count: formatExact(summary.totalTokens ?? total) }) }, h("strong", null, parts.number), h("span", null, [parts.unit, t("tokens")].filter(Boolean).join(" ")))),
        h("div", { className: "dsh-usage-legend" }, rows.map((row) => h("div", { key: row.label, className: "dsh-usage-legend-row" }, h("i", { className: "dsh-usage-legend-dot", style: { background: row.color } }), h("span", null, t(row.label)), h("span", { className: "dsh-usage-legend-value", title: formatExact(row.value) }, formatCompact(row.value))))),
      );
    }
    ...
    function Heatmap({ days, metric }) {
      ...
      days.forEach((day, index) => {
        ...
        cells.push(h("button", {
          ...
          "aria-label": t("{date}. {metric} {value}. {tokens} tokens, {calls} calls, {cost} API equivalent.", { date: formatLongDate(day.date), metric: metricLabel(metric), value: formatMetricExact(value, metric), tokens: formatExact(day.totalTokens || 0), calls: formatExact(day.calls || 0), cost: formatDetailedCost(day.cost || 0) }),
      ...
      return h(React.Fragment, null,
        h("div", { ref: hostRef, className: "dsh-usage-heat-interactive" },
          h("div", { className: "dsh-usage-heat-wrap" }, h("div", { className: "dsh-usage-heat-layout" },
            h("div", { className: "dsh-usage-day-labels", "aria-hidden": "true" }, h("span"), h("span", null, t("M")), h("span"), h("span", null, t("W")), h("span"), h("span", null, t("F")), h("span")),
            h("div", { className: "dsh-usage-heatmap", role: "grid", "aria-label": t("{metric} activity over the last year", { metric: metricLabel(metric) }) }, cells),
          )),
          active ? h("div", { className: "dsh-usage-heat-tooltip", role: "tooltip", style: { left: active.left, top: active.top } },
            ...
            h("span", null, h("b", null, `${metricLabel(metric)}: ${formatMetricExact(metricValue(active.day), metric)}`), t(" · level {level} of 4", { level: formatExact(active.level) })),
            h("span", null, dayDetails(active.day, metric)),
          ) : null,
        ),
        h("div", { className: "dsh-usage-heat-footer" },
          h("span", null, t("{count} active days in the last year", { count: formatExact(days.filter((day) => day.calls > 0).length) })),
          h("span", { className: "dsh-usage-heat-key", "aria-label": t("{metric} per day, quartile color scale from less to more", { metric: metricLabel(metric) }) }, h("b", null, t("{metric} / day", { metric: metricLabel(metric) })), t("Less"), [0,1,2,3,4].map((level) => h("i", { key: level, className: "dsh-usage-heat-cell", "data-level": level, "aria-hidden": "true" })), t("More")),
        ),
      );
    }
    ...
    function Estimate({ value, split = false }) {
      ...
      return h(React.Fragment, null,
        ...
        split ? (parts ? h("span", { className: "dsh-usage-session-meta" },
          t("API estimate {api} · Codex equivalent {codex}", { api: formatCost(parts.api), codex: formatCost(parts.codex) })) :
          h("span", { className: "dsh-usage-session-meta" }, t("Breakdown unavailable"))) : null,
        unpriced ? h("span", { className: "dsh-usage-session-meta dsh-usage-unpriced" }, value.pricedTokens ? t("{count} tokens unpriced", { count: formatExact(value.totalTokens - value.pricedTokens) }) : t("UNPRICED")) : null,
      );
    }
    ...
    function mergeSessionModels(sessions) {
      ...
      return [...models.values()].sort((a, b) => b.cost - a.cost || a.route.localeCompare(b.route, uiLocale()));
    }

    function tokenBreakdown(row) {
      return t("Input {input} · Output {output} · Cache read {read} · Cache write {write}", { input: formatExact(row.input), output: formatExact(row.output), read: formatExact(row.cacheRead), write: formatExact(row.cacheWrite) });
    }

    function SessionModelDetails({ row }) {
      return h("details", { className: "dsh-usage-session-details" },
        h("summary", null, t("Model breakdown")),
        Array.isArray(row.models) ? h("table", { className: "dsh-usage-session-table" },
          h("caption", { className: "dsh-usage-session-caption" }, t("Per-model API equivalents, not actual charges")),
          h("thead", null, h("tr", null, ["Provider / model", "Tokens", "Calls", "API equivalent (USD)"].map((label) => h("th", { key: label, scope: "col" }, t(label))))),
          h("tbody", null, row.models.map((model) => h("tr", { key: model.route },
            h("th", { scope: "row", className: "dsh-usage-session-name" }, model.route,
              h("span", { className: "dsh-usage-session-meta" }, t(costKind(model) === "subscription-equivalent" ? "Codex equivalent · not a subscription charge" : "API estimate · not a confirmed charge"))),
            h("td", { className: "dsh-usage-num" }, formatExact(model.totalTokens),
              h("span", { className: "dsh-usage-session-meta" }, tokenBreakdown(model))),
            h("td", { className: "dsh-usage-num" }, formatExact(model.calls)),
            h("td", { className: "dsh-usage-num" }, h(Estimate, { value: model })),
          ))),
        ) : h("p", { className: "dsh-usage-session-meta" }, t("Model breakdown unavailable in this snapshot; update the Host.")),
      );
    }
    ...
    function ModelTable({ models }) {
      ...
      return h("div", { className: "dsh-usage-model-list" },
        h("div", { className: "dsh-usage-model-head" }, h("span", null, t("Model")), h("span", null, t("Volume")), h("span", { className: "dsh-usage-num" }, t("Calls")), h("span", { className: "dsh-usage-num" }, t("API equivalent"))),
        models.length ? models.map((model) => h("div", { key: model.route, className: "dsh-usage-model-row" },
          h("div", { className: "dsh-usage-model-name" }, h("strong", { title: model.model }, model.model), h("span", { title: model.provider }, model.provider + " · " + t("{count} sessions", { count: formatExact(model.sessions) })), h("span", null, t(costKind(model) === "subscription-equivalent" ? "Codex equivalent · not a subscription charge" : "API estimate"))),
          h("div", null, h("div", null, t("{count} tokens", { count: formatCompact(model.totalTokens) })), h("div", { className: "dsh-usage-model-meter" }, h("i", { style: { width: (model.totalTokens / max * 100).toFixed(1) + "%" } }))),
          h("div", { className: "dsh-usage-num" }, formatCompact(model.calls)),
          h("div", { className: "dsh-usage-num" }, h(Estimate, { value: model })),
        )) : h("div", { className: "dsh-usage-chart-empty" }, t("No model usage in this range")),
      );
    }

    function sessionDay(createdAt, timeZone) {
      if (!Number.isFinite(createdAt)) return t("Unknown date");
      try {
    ...
    function sessionRows(sessions, query, grouping, sort, direction, timeZone) {
      ...
      const matching = sessions.filter((session) => [session.title, session.sessionId, ...(session.routes || [])].some((value) => String(value || "").toLocaleLowerCase(uiLocale()).includes(needle)));
      let rows = matching;
      if (grouping !== "none") {
      ...
      const compare = (a, b) => {
        const primary = sort === "title" ? (a.title || "").localeCompare(b.title || "", uiLocale()) : (a[sort] || 0) - (b[sort] || 0);
        return primary * (direction === "asc" ? 1 : -1) || (a.title || "").localeCompare(b.title || "", uiLocale()) || (a.sessionId || "").localeCompare(b.sessionId || "", uiLocale());
      };
    ...
    function SessionTable({ sessions = [], timeZone = "UTC" }) {
      ...
      const renderRow = (row, child = false) => {
        ...
        const title = row.title || t("Untitled session");
        ...
        return h(React.Fragment, { key: group ? "group:" + row.key : "session:" + row.sessionId },
          h("tr", { className: child ? "dsh-usage-session-member" : undefined },
            h("th", { scope: "row", className: "dsh-usage-session-name" },
              ...
              h("span", { className: "dsh-usage-session-meta" }, group ? t("{count} sessions", { count: formatExact(row.members.length) }) : row.sessionId + " · " + sessionDay(row.createdAt, timeZone)),
              h("span", { className: "dsh-usage-session-meta" }, t("{count} models", { count: formatExact(group ? row.routes.length : row.modelCount || 0) }) + " · " + (row.routes || []).join(" · "))),
      ...
      return h("article", { className: "dsh-usage-panel" },
        h("header", { className: "dsh-usage-panel-head" }, h("div", null, h("h2", { className: "dsh-usage-panel-title" }, t("Sessions")), h("p", { className: "dsh-usage-panel-sub" }, t("API estimates and Codex equivalents, not actual spending. Expand Model breakdown for each provider’s contribution. Groups include matching sessions only.")))),
        h("div", { className: "dsh-usage-session-controls" },
          h("label", null, t("Search sessions"), h("input", { type: "search", value: query, placeholder: t("Title, session ID or route"), onChange: (event) => setQuery(event.target.value) })),
          h("label", null, t("Group by"), h("select", { value: grouping, onChange: (event) => { setGrouping(event.target.value); setExpanded(new Set()); } }, h("option", { value: "none" }, t("No grouping")), h("option", { value: "title" }, t("Exact title")), h("option", { value: "day" }, t("Created day") + " (" + timeZone + ")"))),
          h("label", null, t("Sort by"), h("select", { value: sort, onChange: (event) => { setSort(event.target.value); setDirection(event.target.value === "title" ? "asc" : "desc"); } }, h("option", { value: "cost" }, t("API equivalent")), h("option", { value: "totalTokens" }, t("Tokens")), h("option", { value: "calls" }, t("Calls")), h("option", { value: "title" }, t("Title")))),
          h("button", { type: "button", className: "dsh-usage-button", "aria-label": t("Reverse session sort direction"), onClick: () => setDirection((value) => value === "asc" ? "desc" : "asc") }, t(direction === "asc" ? "Ascending ↑" : "Descending ↓")),
        ),
        h("p", { className: "dsh-usage-panel-sub", role: "status" }, t("{count} of {total} sessions", { count: formatExact(count), total: formatExact(sessions.length) }) + (grouping !== "none" ? " · " + t("{count} groups", { count: formatExact(rows.length) }) + " · " + t("Expand a group to see sessions") : "")),
        rows.length ? h("div", { className: "dsh-usage-session-scroll", role: "region", "aria-label": t("Session usage table"), tabIndex: 0 },
          h("table", { className: "dsh-usage-session-table" }, h("caption", { className: "dsh-usage-session-caption" }, t("Session usage · API equivalents in USD; actual charges unavailable; unpriced tokens excluded")),
            h("thead", null, h("tr", null, ["Session", "Tokens", "Calls", "API equivalent (USD)"].map((label, index) => h("th", { key: label, scope: "col", className: index ? "dsh-usage-num" : undefined }, t(label))))),
            h("tbody", null, rows.map((row) => renderRow(row))),
          ),
        ) : h("div", { className: "dsh-usage-chart-empty" }, t(sessions.length ? "No sessions match your search" : "No session usage in this range")),
      );
    }
    ...
    function ScanStatus({ scan }) {
      ...
      return h(React.Fragment, null,
        activity || isPartialScan(scan) ? h("div", { className: "dsh-usage-panel-sub", role: "status" },
          activity ? h("span", null, t(activity) + " ") : null,
          isPartialScan(scan) ? h("span", null, t("Partial totals") + " · " + t("{cached} of {total} sessions cached", { cached: formatExact(scan.cachedSessions), total: formatExact(scan.totalSessions) }) + " · " + t("{count} pending", { count: formatExact(scan.pendingSessions) })) : null,
        ) : null,
        scan.failed ? h("div", { className: "dsh-usage-notice", role: "status" }, t("Background usage update failed. Previously cached data is still shown; updates will retry automatically.")) : null,
      );
    }
    ...
    function createUsagePoller(url, { onStart, onSnapshot, onError, onIdle }) {
      ...
      const refresh = async () => {
        ...
        try {
          ...
          if (!response.ok) throw new Error(body?.error?.message || t("Usage request failed ({status})", { status: response.status }));
          if (!body) throw new Error(t("Usage response was empty"));
          if (!isCurrent()) return;
          scan = body.scan;
          onSnapshot(body);
        } catch (cause) {
    ...
    function PanelHeader({ title, subtitle, children }) {
      return h("header", { className: "dsh-usage-panel-head" }, h("div", null, h("h2", { className: "dsh-usage-panel-title" }, t(title)), h("p", { className: "dsh-usage-panel-sub" }, t(subtitle))), children);
    }
    ...
    function Dashboard({ snapshot, range, setRange, metric, setMetric, refreshError }) {
      ...
      return h("div", { className: "dsh-usage-dashboard" },
        h("div", { className: "dsh-usage-heading" }, h("div", null, h("h1", null, t("Usage overview")), h("p", null, rangeDescription(snapshot))), h(Segment, { values: RANGES, selected: range, onChange: setRange, label: "Analytics range" })),
        h(ScanStatus, { scan: snapshot.scan }),
        refreshError ? h("div", { className: "dsh-usage-notice", role: "status" }, t("Could not refresh usage. Showing the previous snapshot.") + " " + refreshError) : null,
        h("section", { className: "dsh-usage-cards", "aria-label": t(isPartialScan(snapshot.scan) ? "Partial usage summary" : "Usage summary") },
          ...
          h(StatCard, { label: "Total tokens", value: formatCompact(summary.totalTokens), detail: t("{output} output · {cache} cache read", { output: formatCompact(summary.output), cache: formatCompact(summary.cacheRead) }), accent: "var(--dsh-usage-accent)" }),
          h(StatCard, { label: "Model calls", value: formatCompact(summary.calls), detail: t("{count} sessions", { count: formatExact(summary.sessions) }), accent: "var(--dsh-usage-accent-2)" }),
          h(StatCard, { label: "Active days", value: formatExact(summary.activeDays), detail: t("{count} calendar days", { count: formatExact(snapshot.trend.length) }), accent: "var(--dsh-usage-amber)" }),
        ),
        h("section", { className: "dsh-usage-grid" },
          h("article", { className: "dsh-usage-panel" }, h(PanelHeader, { title: "Usage trend", subtitle: "Combined API equivalent includes Codex; not actual spending" }, h(Segment, { values: METRICS, selected: metric, onChange: setMetric, label: "Chart metric" })), h(TrendChart, { days: snapshot.trend, metric })),
          h("article", { className: "dsh-usage-panel dsh-usage-mix-panel" }, h(PanelHeader, { title: "Token mix", subtitle: "Input, output, and cache" }), h(TokenMix, { summary })),
        ),
        h("article", { className: "dsh-usage-panel" }, h(PanelHeader, { title: "Activity", subtitle: t("Daily color shows {metric} volume", { metric: metricLabel(heatMetric).toLowerCase() }) }, h(Segment, { values: METRICS, selected: heatMetric, onChange: setHeatMetric, label: "Activity color metric" })), h(Heatmap, { days: snapshot.heatmap, metric: heatMetric })),
        h("article", { className: "dsh-usage-panel" }, h(PanelHeader, { title: "Models", subtitle: "Per-route API estimates and Codex equivalents, not bills" }), h(ModelTable, { models: snapshot.models })),
        h(SessionTable, { sessions: snapshot.sessions, timeZone: snapshot.timeZone }),
        h("div", { className: "dsh-usage-notice" }, t("Actual charges are unavailable, not zero. API equivalents do not include subscription fees or prove additional charges. {coverage}% of tokens have a pricing rule. Custom providers use public model list prices unless configured. Cache tokens can count repeated context reads across calls.", { coverage: formatExact(coverage) })),
        snapshot.errors ? h("div", { className: "dsh-usage-notice" }, t("{count} session logs could not be read. Their last cached values are shown when available.", { count: formatExact(snapshot.errors) })) : null,
      );
    }
    ...
    function UsageWorkspace({ disclosure }) {
      ...
      return h("section", { ref: rootRef, className: "dsh-usage-workspace", lang: uiLocale(), "aria-labelledby": titleId },
        h("header", { className: "dsh-usage-toolbar" }, h("span", { className: "dsh-usage-brand" }, h(UsageGlyph, { size: 17 })), h("div", { className: "dsh-usage-title" }, h("strong", { id: titleId }, t("Usage")), h("span", null, snapshot?.scan?.lastUpdatedAt ? t("Last updated {date}", { date: new Date(snapshot.scan.lastUpdatedAt).toLocaleString(uiLocale(), { month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" }) }) : t(snapshot ? (snapshot.scan ? "Not yet updated" : "Cached session analytics") : "Reading usage cache"))), h("button", { type: "button", className: "dsh-usage-button", disabled: loading, onClick: refresh }, h(RefreshGlyph), h("span", { className: "dsh-usage-button-label" }, t("Refresh"))), h("button", { type: "button", className: "dsh-usage-button", "data-dsh-usage-exit": "true", onClick: disclosure.close }, t("Close"))),
        h("div", { className: "dsh-usage-scroll" }, snapshot ? h(Dashboard, { snapshot, range, setRange, metric, setMetric, refreshError: error }) : error ? h("div", { className: "dsh-usage-error" }, h("strong", null, t("Usage unavailable")), h("span", null, error), h("button", { type: "button", className: "dsh-usage-button", onClick: refresh }, t("Try again"))) : h("div", { className: "dsh-usage-loading" }, h("i", { className: "dsh-usage-spinner" }), h("span", null, t("Reading usage cache…")))),
      );
    }

    function SidebarButton({ wide, open, toggle }) {
      useUiLanguage();
      return h("div", { className: "dsh-usage-sidebar" + (wide ? "" : " dsh-usage-sidebar-rail") }, h("button", { type: "button", className: "dsh-usage-sidebar-button", title: wide ? undefined : t("Usage"), "aria-label": t(open ? "Close Usage" : "Open Usage"), "aria-pressed": open, "data-active": open ? "true" : undefined, onClick: toggle }, h(UsageGlyph, { size: wide ? 16 : 18 }), wide ? h("span", { className: "dsh-usage-sidebar-label" }, t("Usage")) : null));
    }

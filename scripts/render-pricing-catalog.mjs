...
const lines = [
  ...
  '',
  `Catalog entries: **${PRICING_CATALOG.length}**. Generated route rules include provider aliases, context/time tiers, and model-name fallbacks for custom providers.`,
  '',
